...
const getMobileSteps = (): TMobileStepConfig[] => {
    ...
    return [
        {
            ...
            image: img('migration-onboarding-step-1-mobile.png'),
        },
        {
        ...
        },
        {
            ...
            image: img('migration-onboarding-step-3-mobile.png'),
        },
        {
            ...
            image: img('migration-onboarding-step-4-mobile.png'),
        },
        {
