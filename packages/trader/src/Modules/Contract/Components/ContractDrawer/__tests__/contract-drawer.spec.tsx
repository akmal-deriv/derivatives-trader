...
jest.mock('Modules/Contract/Components/ContentLoader', () => ({
    ...jest.requireActual('Modules/Contract/Components/ContentLoader'),
    PositionsCardLoader: jest.fn(() => <div>Position Card Loader</div>),
}));
jest.mock('Modules/Contract/Components/ContractAudit', () => jest.fn(() => <div>{contract_audit}</div>));
