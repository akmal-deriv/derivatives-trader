# duration-end-time-fields Specification

## Purpose
TBD - created by archiving change remove-the-down-arrow-from-the-end-time-date-and-time-fields. Update Purpose after archive.
## Requirements
