...
Provides a consistent, theme-aware native scrollbar for scrollable web surfaces so Firefox, Chrome, and Safari render the same thin themed thumb (and matching autohide/hidden behavior) in both light and dark themes.
